...
namespace CityAgent.Systems.Tools
{
    ...
    public class GetBudgetTool : ICityAgentTool
    {
        ...
        public string Description => "Returns the city's financial data: per-category income (tax by zone type), per-category expenses (service upkeep, loan interest, imports, subsidies, map tiles), current balance, and active loan details. All values are raw integers in CS2 city funds units.";
